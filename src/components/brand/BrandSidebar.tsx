...
export default function BrandSidebar({
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-5 left-4 z-50">
        ...
        >
          <Image
            ...
            width={20}
            height={20}
            className={`w-5 h-5 transition-transform duration-300 ${isMobileMenuOpen ? "rotate-" : "rotate-45"}`}
          />
        </button>
      </div>
      ...
      <aside
        className={`w-full min-h-[250vh] max-w-md bg-gray-100 border-r-2 border-gray-300 flex flex-col transition-transform duration-300 ease-in-out ${
          ...
          <div className="flex items-center bg-white border border-gray-200 rounded-full px-4 py-3 shadow-xl">
            ...
            >
              {loading ? (
                ...
                <Image
                  src="/luxufe-icon-ai-send-arrow-light.svg"
                  alt="Send"
                  width={20}
                  height={20}
                  className="w-5 h-5"
