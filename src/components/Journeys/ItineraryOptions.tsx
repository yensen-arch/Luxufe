...
export default function ItineraryOptions() {
  ...
  return (
    <section className="w-full flex justify-center border-t border-gray-200 bg-white py-20">
      <div className="w-full max-w-4xl">
        <h2 className="text-4xl font-arpona font-light text-gray-900 mb-10">Itinerary Options</h2>
        {/* Tabs */}
