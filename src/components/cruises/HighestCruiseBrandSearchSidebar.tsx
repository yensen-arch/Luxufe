...
interface HighestCruiseBrandSearchSidebarProps {
...
const destinationOptions = [
  ...
  "Asia", "Australia & New Zealand", "South America", "Antarctica"
];

const experienceOptions = [
  "Luxury Cruises", "Expedition Cruises", "River Cruises", "Ocean Cruises", 
  "Adults Only", "Family Friendly", "All-Inclusive", "Small Ship"
];

const cruiseLineOptions = [
  "Silversea Cruises", "Seabourn", "Regent Seven Seas", "Crystal Cruises",
  "Oceania Cruises", "Viking Cruises", "Azamara", "Windstar Cruises"
];

const shipNameOptions = [
  "Silver Shadow", "Silver Spirit", "Seabourn Quest", "Seabourn Sojourn",
  "Seven Seas Explorer", "Seven Seas Mariner", "Crystal Symphony", "Crystal Serenity"
];

export default function HighestCruiseBrandSearchSidebar({ onFiltersChange, loading }: HighestCruiseBrandSearchSidebarProps) {
  const [searchTerm, setSearchTerm] = useState("");
  const [travelType, setTravelType] = useState("cruises"); // Set cruises as default
      ...
      <aside className={`w-full min-h-[170vh] max-w-md bg-[#f5f6f7] border-r-2 border-gray-300 flex flex-col transition-transform duration-300 ease-in-out ${
        ...
        <div className="border-b-2 border-gray-300 p-4 md:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-2">
            ...
            <button className="flex items-center justify-center gap-2 bg-white border border-gray-200 rounded-full px-3 py-2 text-xs font-inter font-bold text-gray-400">
              <Calendar className="w-3 h-3 md:w-4 md:h-4" /> Return
            </button>
          </div>
        </div>
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs font-inter font-bold text-gray-400">Cruises that offer exceptional value or discounted rates</span>
            <input 
              type="checkbox" 
