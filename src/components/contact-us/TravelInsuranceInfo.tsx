        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-10">
          ...
          <div className="md:w-1/2 w-full flex flex-col justify-center">
            ...
            {paragraphs.map((paragraph, index) => (
              <p key={index} className="w-5/8 font-inter text-[#23263a] font-bold md:text-sm mb-6">
                {paragraph}
              </p>
            ))}
            <button className="flex items-center justify-center gap-2 border-2 border-gray-300 text-xs w-[200px] mt-10 font-inter text-gray-700 font-bold px-3 py-3 uppercase hover:bg-gray-100">
