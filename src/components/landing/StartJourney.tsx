...
export default function StartJourney({ data }: StartJourneyProps) {
  ...
  return (
    <section className="py-12 md:py-20 lg:py-45 bg-white text-gray-800">
      <div className="container mx-auto px-10 max-w-8xl">
        <div className="text-center mb-8 md:mb-12 lg:mb-16">
          ...
          <p className="max-w-2xl mx-auto text-sm md:text-lg lg:text-md leading-relaxed text-gray-700 font-inter font-bold px-4">
        ...
        <div className="text-center">
          <button className="font-inter font-bold border-1 border-gray-400 text-gray-700 px-4 md:px-6 py-3 md:py-5 text-xs md:text-xs tracking-wider hover:bg-gray-800 hover:text-white hover:border-gray-800 transition-all duration-300">
            + {sectionData.ctaText}
          </button>
        </div>
      </div>
