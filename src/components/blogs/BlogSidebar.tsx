  ...
  return (
    <aside className="flex flex-col items-start w-full max-w-xs">
      ...
      <button className="w-full border border-slate-300 text-slate-700 py-2 md:py-3 mb-3 md:mb-4 font-inter font-bold flex items-center justify-center px-4 md:px-6 text-xs hover:bg-slate-50 transition">
        EXPLORE WITH US <Image src="/luxufe-icon-button-arrow-dark.svg" alt="Arrow right" width={24} height={24} />
      </button>
      <button className="w-full border border-slate-300 text-slate-700 py-2 md:py-3 mb-6 md:mb-8 font-inter font-bold flex items-center justify-center px-4 md:px-6 text-xs hover:bg-slate-50 transition">
        SIGN UP TO BE INSPIRED <Image src="/luxufe-icon-button-arrow-dark.svg" alt="Arrow right" width={24} height={24} />
      </button>
      {/* Social Icons */}
