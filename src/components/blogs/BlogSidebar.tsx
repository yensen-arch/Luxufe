  ...
  return (
    <aside className="flex flex-col items-start w-full max-w-xs">
      ...
      <div className="mb-4 md:mb-6 w-full">
        ...
        />
        <p className="my-3 md:my-4 text-xs font-bold text-slate-700 font-inter">
      ...
      <hr className="w-full my-4 md:my-6 border-slate-300" />
      {/* Explore Section */}
      <h3 className="text-lg md:text-xl font-arpona text-slate-700 mb-3 md:mb-4 font-bold">Explore</h3>
      <button className="w-full border border-slate-300 text-slate-700 py-2 md:py-3 mb-3 md:mb-4 font-inter font-bold flex items-center justify-center px-4 md:px-6 text-xs hover:bg-slate-50 transition">
        EXPLORE WITH US <span className="ml-2">&rarr;</span>
      </button>
      <button className="w-full border border-slate-300 text-slate-700 py-2 md:py-3 mb-6 md:mb-8 font-inter font-bold flex items-center justify-center px-4 md:px-6 text-xs hover:bg-slate-50 transition">
      ...
      <div className="flex gap-4 md:gap-6 mt-2 text-lg md:text-2xl text-slate-400">
        <span><Instagram className="h-5 w-5 md:h-7 md:w-7" aria-label="Instagram" /></span>
        <span><Facebook className="h-5 w-5 md:h-7 md:w-7" aria-label="Facebook" /></span>
        <span aria-label="TripAdvisor">
          <svg className="h-5 w-5 md:h-7 md:w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
