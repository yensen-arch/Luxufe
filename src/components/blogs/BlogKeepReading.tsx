  ...
  return (
    <section className="w-full bg-slate-50 py-12 md:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-arpona font-bold text-center text-[#23263a] mb-8 md:mb-12 lg:mb-16">Keep reading</h2>
          ...
          {posts.map((post, idx) => (
            <div key={idx} className="relative group overflow-hidden bg-black">
              ...
              <div className="absolute left-4 md:left-5 lg:left-6 bottom-4 md:bottom-5 lg:bottom-6 z-20 flex flex-col items-start w-4/5">
                <h3 className="text-lg md:text-xl w-full lg:w-2/3 font-arpona font-bold text-slate-300 mb-4 md:mb-5 lg:mb-6 leading-snug">
                  {post.title}
                </h3>
                <a
                  href={post.href}
