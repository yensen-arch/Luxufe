      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center my-auto lg:ml-20 order-2 lg:order-1">
            <h3 className="w-6/7 text-2xl md:text-3xl lg:text-5xl xl:text-6xl font-arpona font-bold text-[#23263a] mb-4 md:mb-6 lg:mb-8 leading-tight">
              {displayTitle}
            </h3>
          ...
          <div className="w-full lg:w-1/2 flex-shrink-0 order-1 lg:order-2 mb-6 lg:mb-0">
            <Image
              src={displayImageUrl}
              alt={displayImageAlt}
              className="w-full lg:w-[550px] h-[250px] md:h-[350px] lg:h-[390px] xl:h-[550px] mx-auto object-cover shadow-lg"
              width={450}
              height={250}
            />
          </div>
