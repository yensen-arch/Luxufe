      ...
      <div className="flex flex-col gap-4 md:gap-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-6 h-auto lg:h-[800px]">
          ...
          <div className="flex flex-col gap-4 md:gap-6 w-full lg:w-1/2 h-auto lg:h-full">
            ...
            <div className="h-[300px] md:h-[400px] lg:h-3/7 w-full">
              <MasonryCard post={posts[0]} className="h-full shadow-lg" />
            </div>
            {/* Bottom row: 2 cards, 2/3 height */}
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 h-auto lg:h-2/3 w-full">
              <MasonryCard post={posts[1]} className="h-[200px] md:h-[250px] lg:h-full w-full md:w-1/2 lg:w-1/2 shadow-lg" />
              <MasonryCard post={posts[2]} className="h-[200px] md:h-[250px] lg:h-full w-full md:w-1/2 lg:w-1/2 shadow-lg" />
            </div>
          </div>
          {/* Right col */}
          <div className="flex flex-col gap-4 md:gap-6 w-full lg:w-1/2 h-auto lg:h-full">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 h-auto lg:h-2/3 w-full">
              <MasonryCard post={posts[3]} className="h-[200px] md:h-[250px] lg:h-full w-full md:w-1/2 lg:w-1/2 shadow-lg" />
              <MasonryCard post={posts[4]} className="h-[200px] md:h-[250px] lg:h-full w-full md:w-1/2 lg:w-1/2 shadow-lg" />
            </div>
            {/* Bottom row: 1 card, 1/3 height */}
            <div className="h-[300px] md:h-[400px] lg:h-1/3 w-full">
              <MasonryCard post={posts[5]} className="h-full shadow-lg" />
            </div>
          </div>
        </div>
        {/* Row 2: 3 col grid, 1/3 height */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 h-auto lg:h-[550px]">
          <MasonryCard post={posts[6]} className="h-[250px] md:h-[300px] lg:h-full shadow-lg" />
          <MasonryCard post={posts[7]} className="h-[250px] md:h-[300px] lg:h-full shadow-lg" />
          <MasonryCard post={posts[8]} className="h-[250px] md:h-[300px] lg:h-full shadow-lg" />
        </div>
      </div>
    </section>
  );
