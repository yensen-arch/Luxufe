        ...
        <div className="relative flex flex-col lg:flex-row items-center lg:justify-end min-h-[650px]">
          ...
          <div className="bg-gray-100 w-6/8 mt-8 h-screen lg:mt-0 lg:absolute lg:left-0 p-12 z-20">
            <div className="transition-all duration-700 ease-in-out">
              <div className="w-1/2 mr-auto ml-20 mt-40 flex flex-col items-start">
                <h2 className="text-5xl md:text-6xl font-arpona text-[#23263a] mb-8 font-bold">
                  Your Travel,<br />Your Choice
                </h2>
                <p className="text-md leading-relaxed mb-10 max-w-3/5 font-bold font-inter text-[#23263a]">
                  Share your thoughts on luxury travel and see how fellow discerning travelers vote on the week's hottest destinations, experiences, and trends.
                </p>
                <div className="flex gap-6 mt-2 text-2xl text-[#23263a]">
