    ...
    <section className="py-20 md:py-20 lg:py-20 overflow-hidden">
      <div className="container">
        <div className="relative flex flex-col lg:flex-row items-center lg:justify-end min-h-[120vh] lg:min-h-[120vh]">
          ...
          {/* Content Section */}
          <div className="bg-gray-100 w-full lg:w-6/8  h-auto lg:h-[120vh] lg:mt-0 lg:absolute lg:left-0 p-6 md:p-8 lg:p-12 order-2 lg:order-1">
            <div className="transition-all duration-700 ease-in-out">
              <div className="w-full lg:w-2/3 lg:mr-auto lg:ml-40 lg:mt-20">
                <p className="text-lg md:text-xl lg:text-3xl xl:text-5xl font-bellarina text-[#23263a] mb-2 md:mb-3 lg:mb-4">{elevateData.subtitle}</p>
                <h2 className="w-5/6 text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-arpona font-bold mb-4 md:mb-6 lg:mb-8 text-gray-900">
                  {elevateData.title}
                </h2>
                <p className="text-sm md:text-base lg:text-md leading-relaxed mb-3 md:mb-4 max-w-full lg:max-w-3/5 font-inter font-bold">
                  {elevateData.paragraph1}
                </p>
                <p className="text-sm md:text-base lg:text-md leading-relaxed mb-6 md:mb-8 lg:mb-10 max-w-full lg:max-w-3/5 font-inter font-bold">
                ...
                <button className="group inline-flex items-center gap-2 md:gap-3 text-xs font-semibold tracking-widest border border-gray-400 px-4 md:px-5 lg:px-6 py-3 md:py-4 lg:py-5 hover:bg-gray-900 hover:text-white hover:border-gray-900 transition-all duration-300 font-inter font-bold">
                  ...
                  <Image src="/luxufe-icon-button-arrow-dark.svg" alt="Arrow right" width={24} height={24} className="w-3 h-3 md:w-4 md:h-4 lg:w-5 lg:h-5 transition-transform group-hover:translate-x-1" />
                </button>
              </div>
            </div>
          </div>
          ...
          {/* Image Section */}
          <div className="w-full lg:w-3/7 h-auto lg:h-full z-10 order-1 lg:order-2 mb-6 lg:mb-0">
            <div className="relative overflow-hidden shadow-2xl">
              <img
                src={elevateData.image.url}
                alt={elevateData.image.alt}
                className="w-full h-[360px] md:h-[460px] lg:h-[660px] object-cover"
              />
            </div>
          </div>
