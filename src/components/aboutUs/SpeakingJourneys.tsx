    ...
    <section className="my-12 md:my-0 lg:my-0 h-auto md:h-screen">
      <div className="container mx-auto h-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 h-full items-center relative">
          ...
          <div 
            className="bg-cover bg-center lg:col-span-12 h-[60vh] md:h-[70vh] lg:h-full text-center lg:text-left p-6 md:p-12 lg:p-24 flex items-center order-2 lg:order-1"
          ...
          >
            <div className="w-full lg:w-3/7 flex flex-col items-center lg:items-start justify-center">
              ...
              <div className="flex gap-4 md:gap-5 lg:gap-6 mt-6 md:mt-7 lg:mt-8 mx-auto lg:mx-0">
                <button 
                  onClick={scrollPrev} 
                  className="bg-white rounded-full px-4 md:px-5 lg:px-7 lg:py-8 shadow-md hover:bg-white transition"
                >
