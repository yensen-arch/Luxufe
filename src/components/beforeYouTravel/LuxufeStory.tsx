        ...
        <div className="flex">
          ...
          <div className="w-4/6 bg-slate-800 flex items-center justify-center px-8 py-16 lg:px-16 min-h-screen">
            <div className="max-w-2xl text-white">
              ...
              Luxury travel is not just about extravagance for Luxufe’s founder Ati Jain. It is about removing friction and creating experiences that feel instinctively effortless.<br /><br />
