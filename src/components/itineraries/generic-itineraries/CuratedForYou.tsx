  ...
  return (
    <section className="py-8 md:py-20 my-12 md:my-40 bg-white text-gray-800 relative overflow-hidden">
      ...
      <div className="text-center mt-8 md:mt-16 flex flex-col md:flex-row justify-center gap-3 md:gap-4 px-4 md:px-0">
        <button className="border-2 border-gray-300 text-gray-800 px-3 md:px-6 py-2 md:py-4 hover:bg-gray-800 hover:text-white transition flex items-center justify-center gap-2 text-xs">
          EXPLORE ALL JOURNEYS <Image src="/luxufe-icon-button-arrow-dark.svg" alt="Arrow right" width={24} height={24} className="h-3 w-3 md:h-5 md:w-5" />
        </button>
      </div>
    </section>
  )
