...
export default function Hero() {
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 flex flex-col items-center justify-center w-3/4 px-4 text-center">
        <span className="font-bellarina text-3xl md:text-5xl text-white mb-4 block">Journerys Designed Around You</span>
        <h1 className="text-white text-5xl md:text-6xl font-arpona font-medium mb-8 leading-tight">
          Discover the world's finest travel experiences, curated to your rhythm
        </h1>
      </div>
