    ...
    <section className="bg-white border-t-2 border-gray-300">
      <div className="mx-auto flex flex-col md:flex-row">
        ...
        <div className="border-b-2 border-gray-300 w-full">
          ...
          <nav className="flex flex-col gap-3 md:gap-4 mb-6 md:mb-8 text-md font-inter font-bold px-4 md:px-8 pt-6 md:pt-8">
            <a href="#" className="hover:underline font-inter font-bold">Trip Overview</a>
            <a href="#" className="hover:underline">Map & Highlights</a>
            <a href="#" className="hover:underline font-inter">Daily Itinerary</a>
            <a href="#" className="hover:underline font-inter">Pricing & Options</a>
            <a href="#" className="hover:underline font-inter">The Ship</a>
          ...
          <div className="text-xs max-w-1/2 mt-8 md:mt-12 mx-auto text-center font-inter font-bold text-gray-700 px-4 md:px-0">
        ...
        <div className="md:w-3/4 p-6 md:p-20 border-l-2 border-gray-300">
          ...
          <div className="flex flex-col md:flex-row w-full md:w-4/5 items-start md:items-center bg-[#E3EFF1] border border-[#A5C8CE] p-4 md:p-6 mb-8 md:mb-10">
            ...
            <button className="md:ml-6 border-2 text-xs border-gray-400 px-4 md:px-6 py-2 md:py-2 font-inter font-bold text-gray-700 flex items-center gap-2 hover:bg-gray-800 hover:text-white transition w-full md:w-auto justify-center">VIEW DETAILS <span><img src="/luxufe-icon-button-arrow-dark.svg" alt="arrow-right" className="w-4 h-4 md:w-6 md:h-6" /></span></button>
          </div>
          {/* Journey at a Glance */}
