      ...
      <div className="mx-auto flex flex-col md:flex-row">
        ...
        <div className="border-b border-gray-400 w-full">
          ...
          <div className="flex flex-col gap-3 md:gap-4 mb-6 md:mb-8 px-4 md:px-8 pt-6 md:pt-8">
            <button className="w-full border border-gray-400 text-xs py-2 md:py-3 font-inter font-bold text-gray-800 flex items-center justify-center gap-2 hover:bg-gray-800 hover:text-white transition">BOOK THIS ITINERARY <span>&rarr;</span></button>
            <button className="w-full border border-gray-400 text-xs py-2 md:py-3 font-inter font-bold text-gray-800 flex items-center justify-center gap-2 hover:bg-gray-800 hover:text-white transition">CONTACT US <span>&rarr;</span></button>
            <button className="w-full border border-gray-400 text-xs py-2 md:py-3 font-inter font-bold text-gray-800 flex items-center justify-center gap-2 hover:bg-gray-800 hover:text-white transition">SEND TO A FRIEND <span>&rarr;</span></button>
          </div>
        ...
        {/* Main Content */}
        <div className="md:w-3/4 p-6 md:p-20 border-t border-l border-gray-300">
          ...
          <div className="flex flex-col md:flex-row w-full md:w-4/5 items-start md:items-center bg-[#E3EFF1] border border-[#A5C8CE] p-4 md:p-6 mb-8 md:mb-10">
            ...
            <button className="md:ml-6 border text-xs border-gray-400 px-4 md:px-6 py-2 md:py-3 font-inter font-bold text-gray-700 flex items-center gap-2 hover:bg-gray-800 hover:text-white transition w-full md:w-auto justify-center">VIEW DETAILS <span>&rarr;</span></button>
          </div>
          {/* Journey at a Glance */}
